...
# Урок 5
## На уроке
35. В файле находится N натуральных чисел, записанных через пробел. Среди чисел не хватает
одного, чтобы выполнялось условие $А[i] - 1 = А[i-1]$. Найдите это число.
...
> Пример:
> - [1, 5, 2, 3, 4, 6, 1, 7] => [1, 2, 3] или [1, 7] или [1, 6, 7] ит.д.
...
## На уроке
## Домашнее задание
Задачи из [базы тестовых заданий с реальных собеседований на позицию программиста](https://www.dropbox.com/s/7n18ccc3dgxf8u9/workbook.pdf?dl=0).
